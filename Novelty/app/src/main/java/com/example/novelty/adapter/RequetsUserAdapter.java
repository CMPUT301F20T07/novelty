...
public class RequetsUserAdapter extends BaseAdapter {

    private List<RequestBean> list = new ArrayList<RequestBean>();
    private Context context;

    public RequetsUserAdapter(List<RequestBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tv_name.setText(list.get(position).getStatus());
        return convertView;
    }
