...
public class SearchBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userInfo.addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            @Override
            public void onEvent(@Nullable QuerySnapshot user, @Nullable FirebaseFirestoreException error) {
                for (QueryDocumentSnapshot userdocumentSnapshot : user) {
                    if(userdocumentSnapshot.getId() != uid){
                        bookInfo = Database.getBookInfo(userdocumentSnapshot.getId());
...
//                                        mBookList.add(new BookBean(data.get("book_name").toString(), data.get("description").toString(), "request", data.get("author").toString()));
                                        mBookList.add(new BookBean(title, description, "request", author));
                                    }
